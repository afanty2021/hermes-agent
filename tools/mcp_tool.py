...
def _is_application_level_mcp_error(exc: BaseException) -> bool:
    ...
    bumping as before. (Upstream #11113 keeps burning application strikes and
    only fixes the open-breaker wording; this fork resets instead — the
    answered-error-is-reachability call, pinned by
