...
def _plan_execution(
    ...
    # Preprocess command to enable adaptive timeout detection: add progress
    # output to commands that would otherwise be silent, so base.py's idle
    # timeout can tell a busy command from a hung one.
