...
class TestInboundImageClassification:
    ...
    async def test_inbound_image_archived_with_chat_id(self, monkeypatch, tmp_path):
        ...
        09-10/09-11 两图已实证被清），_cache_inbound_image 须在
        ...
        monkeypatch.setattr(
            adapter_mod, "get_hermes_dir", lambda new, old, home=None: archive
        )
    ...
    async def test_archive_failure_does_not_break_inbound(self, monkeypatch):
        ...
        monkeypatch.setattr(adapter_mod, "get_hermes_dir", broken_dir)
