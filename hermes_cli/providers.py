...
HERMES_OVERLAYS: Dict[str, HermesOverlay] = {
    ...
    "zai-coding-cn": HermesOverlay(extra_env_vars=("GLM_API_KEY", "ZAI_API_KEY", "Z_AI_API_KEY"), base_url_env_var="GLM_BASE_URL"),
...
_ALIAS_GROUPS: Dict[str, Tuple[str, ...]] = {
    "openrouter": ("openai",), "zai": ("glm", "z-ai", "z.ai", "zhipu"), "zai-coding-cn": ("glm-cn", "zai-cn", "zhipu-cn"), "xai": ("x-ai", "x.ai", "grok"),
