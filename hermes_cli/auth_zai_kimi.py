...
ZAI_ENDPOINTS = [
    ...
    # fork: Coding Plan endpoints FIRST (cheaper; billing channel pin, 29da031687). Upstream keeps
    # coding last — re-apply this order after every upstream merge. detect_zai_endpoint()'s
    # priority walk follows list order, so the probe still falls back to the plain endpoints.
