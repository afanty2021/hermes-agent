...
_PROVIDER_MODELS: dict[str, list[str]] = {
    ...
    "zai": [
        ...
        "glm-4.7", "glm-4.5-air", "glm-4.5", "glm-4.5-flash",
    ],
...
CANONICAL_PROVIDERS: list[ProviderEntry] = [ProviderEntry(*row) for row in (
    ...
    ("zai-coding-cn", "Z.AI / GLM (China Coding)", "Z.AI / GLM China Coding Plan (open.bigmodel.cn/coding)"),
...
_PROVIDER_ALIASES = dict((
    ...
    ("glm-cn", "zai-coding-cn"), ("zai-cn", "zai-coding-cn"), ("zhipu-cn", "zai-coding-cn"),
    ("github", "copilot"),
